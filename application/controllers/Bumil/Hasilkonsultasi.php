...
class Hasilkonsultasi extends CI_Controller
{
	...
	function perhitungan(){
		...
		// $gejala1 		= $this->input->post(""); 
		// $gejala2 		= $this->input->post(""); 
		// $gejala3 		= $this->input->post(""); 
		// $gejala4 		= $this->input->post(""); 
		// $gejala5 		= $this->input->post(""); 
		// $gejala6		= $this->input->post(""); 
		// $gejala7 		= $this->input->post(""); 
		// $gejala8 		= $this->input->post(""); 
		// $gejala9 		= $this->input->post(""); 
		// $gejala10 	= $this->input->post(""); 
		// $gejala11 	= $this->input->post(""); 
		// $gejala12 	= $this->input->post(""); 
		// $gejala13 	= $this->input->post(""); 
		// $gejala14 	= $this->input->post(""); 
		// $gejala15 	= $this->input->post(""); 
		$gejala1 		= 0; 
		$gejala2 		= 0.2; 
		$gejala3 		= 0; 
		$gejala4 		= 0.2; 
